...
class EditExcelQuizScreen extends StatefulWidget {
  final Map<String, dynamic> quiz;

  const EditExcelQuizScreen({Key? key, required this.quiz}) : super(key: key);

  @override
  _EditExcelQuizScreenState createState() => _EditExcelQuizScreenState();
}

class _EditExcelQuizScreenState extends State<EditExcelQuizScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Edit Quiz from Excel"),
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            const Text("Questions:", style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color(0xFF9C27B0))),
            const SizedBox(height: 10),
            Expanded(
  ...
  void dispose() {
    ...
    for (var options in _optionControllers) {
      for (var optionController in options) {
